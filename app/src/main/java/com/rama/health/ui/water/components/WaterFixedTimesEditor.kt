...
fun WaterFixedTimesEditor(
    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text(
            text = stringResource(R.string.water_reminder_fixed_times_label),
            ...
            Row(
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.water_reminder_remove_time),
                    )
                }
            }
        }
        ...
        OutlinedButton(
            ...
            Text(stringResource(R.string.water_reminder_add_time))
        }
    }
    ...
    if (showAddPicker) {
        ReminderTimePickerDialog(
            initialTime = MedicationTime(9, 0),
...
@Composable
private fun WaterFixedTimesEditorPreview() {
    HealthTrackerAppTheme {
        WaterFixedTimesEditor(
            times = listOf(MedicationTime(9, 0), MedicationTime(14, 30)),
            onTimesChanged = {},
        )
    }
}
